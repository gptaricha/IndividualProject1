...
public class ToDoLy {
    ...
    //private final LocalDate formatter;
...
public void addTaskPrompt() {
        ...
        if(taskDetail.isEmpty()) {
                taskDetail = read.getValidCommand();
        }
        System.out.println("Enter the Due Date: ");
        String sDate = read.getCommand();
    ...
    public void editTask() {
        try {
            ...
            String taskToEditInString = read.getCommand();
            if(taskToEditInString.isEmpty()||read.isSpecialCharacter(taskToEditInString)) {
                taskToEditInString = read.getValidCommand();
            }
            int taskToEdit = Integer.parseInt(taskToEditInString);
    ...
    public void updateTask(Task selectedTask) {
        ...
        //Date newDueDate = formatter.parse(read.getCommand());
